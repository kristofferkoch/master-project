...
turing computable function has a QDI implementation.
...
implementation illustrating this is shown in figure~\ref{drgate},
...
protocol (figure~\ref{fig:bundled}~b)), as the combinational circuits
must return to the NULL state between values to distinguish successive
